...
from sqlalchemy import (
    ...
    Integer, String, Text, Table, JSON, Index, func, delete,
)
...
class Staff(Base):
    ...
    department = relationship("Department", back_populates="staff_members", foreign_keys="Staff.department_id")
    attendances = relationship("Attendance", back_populates="instructor", foreign_keys="Attendance.instructor_id")
...
class Section(Base):
    ...
    __table_args__ = (
        Index("idx_section_course_semester", "course_id", "semester", "year"),
    )
...
class Enrollment(Base):
    ...
    __table_args__ = (
        Index("idx_enrollment_student_section", "student_id", "section_id", unique=True),
    )
